...
const OurServices = () => {
  ...
  useGSAP(
    () => {
      ...
      const images = gsap.utils.toArray(".panel-visual");

      panels.forEach((panel, i) => {
        if (panels.length - 1 === i) return;
      ...
      <div className="vertical-panel">
          ...
          <div className="c-panel-left">
            ...
            <div className="c-panel-desc">
              <div className="t-base">
                ...
                Similique laborum recusandae provident dolorem voluptatibus
                rerum culpa obcaecati debitis doloremque nesciunt.
              </div>
            </div>
        ...
        <div className="panel-ser c-panel-3">
          <div className="c-panel-left">
            ...
            <div className="c-panel-desc">
              <div className="t-base">
                We deliver enterprise-grade cybersecurity to protect your
                business across cloud, servers, and user identities. Our CISO
                services cover Microsoft Entra ID, Active Directory, MFA,
                Conditional Access, endpoint protection, email security, SIEM,
                and compliance frameworks such as NIST, SOC 2, HIPAA, and PCI.
                We help prevent breaches, reduce risk, and keep your environment
                secure.
              </div>
            </div>
            <div className="c-panel_bt">
              <h1 className="primary-font">
                Cybersecurity & Protection (CISO)
              </h1>
            </div>
          </div>
          <div className="c-panel-visual">
        ...
        <div className="panel-ser c-panel-1">
          <div className="c-panel-left">
            ...
            <div className="c-panel-desc">
              <div className="t-base">
                We design and manage recovery solutions for ransomware, system
                failures, and cloud outages. Our services include backup and
                restore for Microsoft 365, Azure, AWS, VMware, Hyper-V,
                databases, file servers, and Active Directory. We ensure rapid
                recovery, business continuity, and minimal downtime when
                incidents occur.
              </div>
            </div>
            <div className="c-panel_bt">
        ...
        <div className="panel-ser c-panel-2">
          <div className="c-panel-left">
            ...
            <div className="c-panel-desc">
              <div className="t-base">
                We build and manage modern IT environments using Azure, AWS,
                Google Cloud, VMware, Hyper-V, and hybrid cloud. Our expertise
                includes virtual machines, networking, firewalls, VPNs, storage,
                Azure Virtual Desktop (AVD), load balancing, high availability,
                patching, upgrades, and cloud migrations.
              </div>
            </div>
            <div className="c-panel_bt">
        ...
        <div className="panel-ser c-panel-3">
          <div className="c-panel-left">
            ...
            <div className="c-panel-desc">
              <div className="t-base">
                We provide experienced engineers and architects to support your
                most critical IT initiatives. Our consultants specialize in
                cloud migration, identity management, cybersecurity, Microsoft
                365, infrastructure upgrades, automation with PowerShell and
                APIs, and enterprise system integration.
              </div>
            </div>
            <div className="c-panel_bt">
