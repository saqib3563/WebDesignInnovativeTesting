    ...
    >
      <div className="padd-x">
        ...
        <p className={`${instrument_sans.className} abt-para `}>
          ...
          scalable digital ecosystems built for performance, growth, and
          long-term success.
        </p>
      </div>
      ...
      <div className="slide-strip-wrapper">
          ...
          >
            <SwiperSlide>
              ...
              <div className="slide-item">
                <Image src={slideImg1} alt="" className="img-fluid" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="slide-item">
                <Image src={dot} alt="" className="img-fluid dot-img" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="slide-item">
                <Image src={slideImg2} alt="" className="img-fluid" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="slide-item">
            ...
            <SwiperSlide>
              <div className="slide-item">
                <Image src={slideImg3} alt="" className="img-fluid" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="slide-item">
            ...
            <SwiperSlide>
              <div className="slide-item">
                <Image src={slideImg4} alt="" className="img-fluid" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="slide-item">
            ...
            <SwiperSlide>
              <div className="slide-item">
                <Image src={slideImg5} alt="" className="img-fluid" />
              </div>
            </SwiperSlide>
            <SwiperSlide>
              <div className="slide-item">
        ...
        <Image
          src={webBoxImg}
          alt="web_innovator_box"
          className="innovation_box"
        />
      </div>
      <div className="padd-x">
        <p className="primary-font second-para">
          Where imagination and technology collide in a bold, futuristic
          aesthetic. Our work blends neon glow, experimental design, and sharp
          creative strategy.
        </p>
      </div>
    </section>
