...
const ProDesignSection = () => {
  ...
  useGSAP(() => {
    ...
    if (width <= 768) {
      gsap.set(".pro-section .card-1", { y: 0, zIndex: 1 });
      gsap.set(".pro-section .card-2", { y: 0, zIndex: 2 });
      gsap.set(".pro-section .card-3", { y: 0, zIndex: 3 });
      return;
    }

    gsap.set(".pro-section .card-1", { y: 0, zIndex: 1 });
    gsap.set(".pro-section .card-2", { y: "160%", zIndex: 2 });
    gsap.set(".pro-section .card-3", { y: "160%", zIndex: 3 });
